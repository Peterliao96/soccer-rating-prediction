...
\noindent For gradient Boosting, we do 75/25 splitting. We will generally use two tunning method to choose parameters. The first method is to use \verb caret \ package. This requires a few minutes to tune the parameters. \\
\begin{table}[h]
    \label{default_model}
    \centering
    \begin{tabular}{l c c}
